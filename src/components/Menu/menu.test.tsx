...
describe('menu test and menu-item component', () => {
  beforeEach(() => {
  ...
  it('should render corrent menu and menu-item based on default props', () => {
    expect(menuElement).toBeInTheDocument()
    expect(menuElement).toHaveClass('cute-menu test')
